"""
Detector Utilities Module for Gestro
Author: Rakin Mohammed Rafeeq
Description: Core detection utilities for real-time hand tracking with TensorFlow
"""
import numpy as np
import sys
...
# Multi-threaded webcam capture for improved performance
