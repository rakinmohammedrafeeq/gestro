"""
Dataset Preparation Module for Gestro
Author: Rakin Mohammed Rafeeq
Description: Downloads and processes the EgoHands dataset, generating CSV files 
             and train/test splits for SSD MobileNet training
"""
